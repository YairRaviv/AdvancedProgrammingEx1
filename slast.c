...
void calculate_time(time_t prev_time , time_t cur_time);

void print_with_0(int num);
...

{
...

    {
...

        {
            ...
            calculate_time(prev_time,current_user->ut_tv.tv_sec);
...

{
    ...
    time_t diff =  prev_time - cur_time;
...

    {
        ...
        int only_min = min - (hours*60);

        print_with_0(hours);

        printf(":");

        print_with_0(only_min);
